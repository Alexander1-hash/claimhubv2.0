          ...
          <div className="steps-list">
            <div className=" step-box step-1">
              <div className="step-text">
                ...
                <p>
                  {" "}
                  <IoMdCheckmarkCircleOutline /> Via our online application form
                </p>
              </div>
            </div>
            <div className=" step-box step-2">
              <div className="step-text">
                ...
                <p>
                  <IoMdCheckmarkCircleOutline /> We submit the claim on your
                  behalf.
                </p>
              </div>
            </div>
            <div className="step-box step-3">
              <div className="step-text">
                ...
                <p>
                  {" "}
                  <IoMdCheckmarkCircleOutline /> Money transferred to your
                  account
                </p>
              </div>
            </div>
